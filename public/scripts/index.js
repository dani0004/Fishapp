...
function loadItems(){
	...
	console.log("lin load items");
		xhrGet("api/species", function(data){
			console.log("getting api species!!!");
...
function updateServiceInfo(){
	console.log("in update service info for web client");
	xhrGet(REST_ENV, function(vcapServices){
		console.log("in xhr get");
		var sqldbInfo;
